...
@Component({
  selector: 'app-form-sales-order',
  imports: [RouterModule, CommonModule, FormsModule, ShoppingCartComponent],
  templateUrl: './form-sales-order.component.html',
  styleUrl: './form-sales-order.component.scss',
})
export class FormSalesOrderComponent {
  isShopingCartOpen: boolean = true;
  ...
  toggleShoppingCart() {
    this.shoppingCartService.setBtpCode('SO');
